...
class RoboTrader:
    def __init__(self, platform, balance=5000):
        ...
        self.price_momentum = ExpAvg(beta=beta_30_days, fn=Momentum(price))
        self.price_avg = ExpAvg(beta=beta_30_days, fn=price)
    ...
    def step(self):
        ...
        self.decide_actions()
        self.history['position'].append( sum(p.amount for p in self.account.positions) )
